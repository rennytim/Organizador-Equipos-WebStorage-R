...
export default class Cl_vTorneo extends Cl_vGeneral {
  ...
  private inNombreEquipo: HTMLInputElement;
  private inLicencia1: HTMLInputElement;
  private inLicencia2: HTMLInputElement;
  private inLicencia3: HTMLInputElement;
  private inLicencia4: HTMLInputElement | null;
  private inLicencia5: HTMLInputElement | null;
  ...
  limpiarImputs() {
    ...
    if (this.inLicencia4) this.inLicencia4.value = "";
    if (this.inLicencia5) this.inLicencia5.value = "";
  }
